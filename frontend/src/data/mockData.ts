...
export const JOBS: Job[] = [
  { id: 1, title: "Coiffeur Coloriste H/F", salon: "Salon Éclat Paris", location: "Paris 8e", rate: 18, shift: "9h – 18h", contract: "CDI", match: 94, tags: ["CAP Coiffure", "Coloriste", "Balayage"], image: "https://images.unsplash.com/photo-1634449571010-02389ed0f9b0?w=800&h=400&fit=crop&auto=format", description: "Rejoignez notre équipe au cœur du 8e arrondissement. Vous serez en charge des colorations, balayages et soins capillaires pour une clientèle haut de gamme, dans un salon réputé reconnu par Vogue Beauty.", diplomas: ["CAP Coiffure (obligatoire)", "BP Coiffure (souhaité)"], benefits: ["Tickets repas 9€/j", "Prime assiduité 150€/mois", "Navigo 50%", "Mutuelle premium"], urlOrigine: "https://candidat.francetravail.fr/offres/recherche" },
  { id: 2, title: "Visagiste & Coloriste", salon: "Studio Marais Beauty", location: "Paris 4e", rate: 16, shift: "10h – 19h", contract: "Freelance", match: 81, tags: ["Visagisme", "Coloriste", "Mèches"], image: "https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=800&h=400&fit=crop&auto=format", description: "Studio indépendant au Marais recherche un·e visagiste et coloriste pour missions régulières. Clientèle créative, espace de travail inspirant, grande autonomie dans votre pratique artistique.", diplomas: ["CAP Coiffure", "Certificat Visagisme apprécié"], benefits: ["Flexibilité horaire totale", "Clientèle fidélisée", "Commission 15%"], urlOrigine: "https://candidat.francetravail.fr/offres/recherche" },
  { id: 3, title: "Coiffeur Expert Hommes", salon: "Barber & Co Lyon", location: "Lyon 2e", rate: 15, shift: "8h – 17h", contract: "CDI", match: 73, tags: ["Coupe Homme", "Rasage", "Dégradé"], image: "https://images.unsplash.com/photo-1503951914875-452162b0f3f1?w=800&h=400&fit=crop&auto=format", description: "Barber & Co recrute un·e coiffeur·se spécialisé·e coupe homme pour renforcer son équipe lyonnaise. Ambiance moderne, clientèle masculine fidèle, outils professionnels fournis.", diplomas: ["CAP Coiffure (obligatoire)"], benefits: ["Primes performance", "Formation Wahl Academy", "Parking gratuit"], urlOrigine: "https://candidat.francetravail.fr/offres/recherche" },
  { id: 4, title: "Coloriste Balayage Senior", salon: "L'Oréal Professionnel", location: "Paris 9e", rate: 22, shift: "9h – 18h", contract: "CDI", match: 88, tags: ["Coloriste", "Balayage", "BP Coiffure"], image: "https://images.unsplash.com/photo-1562322140-8baeececf3df?w=800&h=400&fit=crop&auto=format", description: "L'Oréal Professionnel recherche un·e coloriste senior expert·e en techniques balayage et ombré pour intégrer son salon flagship du 9e arrondissement.", diplomas: ["BP Coiffure", "Formation colorimétrie"], benefits: ["Salaire fixe + variable", "Formations L'Oréal", "CE avantageux", "Tickets repas"], urlOrigine: "https://candidat.francetravail.fr/offres/recherche" },
];
